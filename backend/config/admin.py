...
try:
    mobility_admin_site.register(Group, GroupAdmin)
    mobility_admin_site.register(User, UserAdmin) 
    mobility_admin_site.register(LogEntry, ModelAdmin)
except admin.sites.AlreadyRegistered:
    pass  # Ya están registrados
