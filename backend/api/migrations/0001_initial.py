# Generated by Django 5.1.9 on 2025-05-31 15:27

import api.models.vehiculos
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('valor_tarifa', models.DecimalField(decimal_places=2, default=Decimal('0.00'), help_text="Valor de la tarifa según el tipo: para 'porcentaje' es el % a aplicar (ej: 25.00 para 25%), para 'fijo' es el importe fijo en euros, para 'importe_dia' es el importe por día de alquiler", max_digits=10, validators=[django.core.validators.MinValueValidator(Decimal('0.00'))], verbose_name='Valor de la tarifa')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('imagen', models.ImageField(blank=True, help_text='Imagen del vehículo que se guardará en la carpeta especificada', null=True, upload_to=api.models.vehiculos.imagen_vehiculo_upload_path, verbose_name='Imagen del vehículo')),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['politica_pago', 'tipo_penalizacion'], name='politica_pe_politic_deb810_idx'),
        ),
        migrations.AddIndex(
            model_name='politicapenalizacion',
            index=models.Index(fields=['horas_previas'], name='politica_pe_horas_p_eb9c4b_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='politicapenalizacion',
