...
class VehiculoFilter(django_filters.FilterSet):
    ...
    precio_min = django_filters.NumberFilter(field_name='tarifas__precio_dia', lookup_expr='gte')
    precio_max = django_filters.NumberFilter(field_name='tarifas__precio_dia', lookup_expr='lte')
