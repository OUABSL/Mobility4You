...
urlpatterns = [
    ...
    path('stripe/confirm-payment-intent/', ConfirmPaymentIntentView.as_view(), name='confirm_payment_intent'),
    path('stripe/payment-status/<str:numero_pedido>/', PaymentStatusView.as_view(), name='payment_status'),
    path('stripe/refund/<int:pago_id>/', RefundPaymentView.as_view(), name='refund_payment'),
    path('stripe/payment-history/', PaymentHistoryView.as_view(), name='payment_history'),
    ...
    path('payment-status/<str:order_number>/', check_payment_status_legacy, name='payment_status_legacy'),
